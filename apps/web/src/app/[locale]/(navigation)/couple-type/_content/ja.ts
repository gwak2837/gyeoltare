...
export const coupleTypeContent = {
  ...
  ui: {
    ...
    ctaDescription:
      "このテストはブラウザ内だけで計算されます。Gyeoltareのプレビューでは、原文を直接引用せずに会話パターンをより細かく見られる流れを準備しています。",
    ctaLink: "Gyeoltare無料プレビュー",
    ctaTitle: "会話の原文なしでも、もっと深く見られます",

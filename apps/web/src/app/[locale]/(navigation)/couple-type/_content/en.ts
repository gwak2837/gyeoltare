...
export const coupleTypeContent = {
  ...
  metadata: {
    ...
    title: "Couple Conversation Type - Gyeoltare",
  },
  ...
  ui: {
    ...
    ctaDescription:
      "This test is calculated only in your browser. In the Gyeoltare preview, we are preparing a flow that reads conversation patterns more deeply without directly quoting original messages.",
    ctaLink: "Free Gyeoltare preview",
    ctaTitle: "See more deeply without sharing raw messages",

...
export const rarityContent = {
  ...
  grades: {
    1: {
      description:
        "結タレモデルでは、四つの軸がすべてはっきり噛み合っている組み合わせです。ふたりだけの基準が強く、一緒にいる時の関係の結がくっきり見えます。",
      label: "1等級",
      mountainLabel: "鮮明な結",
    },
    2: {
  ...
  results: {
    ...
    rare: {
      ...
      summary:
        "ふたりの結は、結タレモデル基準でかなり鮮明な組み合わせです。外からは普通の瞬間に見えても、ふたりの間ではすぐ通じる基準のように働きます。",
    },
    reconnect: {
      mission:
  ...
  ui: {
    ...
    modelStepGradeBody: "選択の組み合わせを結タレモデル基準で読み、1等級から7等級までの位置を見せます。",
    ...
    modelNotice: "正解を当てる検査ではなく、回答の組み合わせを結タレモデル基準で読んだ結果です。",
    nextButton: "次の質問",

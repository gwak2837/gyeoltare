...
export const rarityContent = {
  ...
  grades: {
    1: {
      description:
        "在结线模型里，四个维度都非常清晰地咬合在一起。你们有很强的共同标准，在一起时关系的纹理会很鲜明地显出来。",
      label: "1级",
      mountainLabel: "清晰的结",
    },
    2: {
  ...
  results: {
    ...
    rare: {
      ...
      summary: "按结线模型来看，你们的结是相当清晰的组合。别人眼里普通的瞬间，在你们之间也会像马上能懂的标准一样运作。",
    },
    reconnect: {
  ...
  ui: {
    ...
    emptyResultDescription: "分享链接格式不正确。重新回答 16 个问题即可生成新的结果卡。",
    emptyResultTitle: "要重新生成结果卡吗？",
    gradeTitle: "我们的结等级",
    heroCta: "查看情侣结指数",
    heroDescription: "通过 16 个问题，轻松看看爱意温度、生活节奏、关系平衡和恢复力。",
    heroEyebrow: "16 个问题，大约 2 分钟",
    heroSecondaryCta: "会看什么？",
    heroTitle: "我们之间的结有几分？",
    indexLabel: "情侣结指数",
    introNote: "不用登录，可以马上开始。",
    missionTitle: "今天可以试的小任务",
    modelStepGradeBody: "根据结线模型读取回答组合，并显示从 1 级到 7 级的位置。",
    modelStepGradeTitle: "查看等级",
    modelStepInputBody: "只会询问爱意温度、生活节奏、关系平衡、恢复力等可以马上选择的问题。",
    modelStepInputTitle: "16 个问题",
    modelStepShareBody: "把分数、等级、昵称和一句总结整理成适合截图或发送的卡片。",
    modelStepShareTitle: "分享卡",
    modelNotice: "这不是寻找正确答案的测试，而是根据结线模型读取回答组合的结果。",
    nextButton: "下一题",
    questionEyebrow: "16 题测试",

...
export const rarityContent = {
  ...
  grades: {
    1: {
      description:
        "In the Gyeoltare model, all four axes lock together very clearly. The two of you have strong shared standards, and your relationship pattern stands out when you are together.",
      label: "Grade 1",
  ...
  metadata: {
    ...
    title: "Couple Gyeol Index Test - Gyeoltare",
  },
  questions: [
    {
      id: "duration",
  ...
  results: {
    ...
    rare: {
      ...
      summary:
        "In the Gyeoltare model, your gyeol is a notably clear combination. Even ordinary moments can work like standards only the two of you immediately understand.",
    },
    reconnect: {
      mission:
  ...
  ui: {
    ...
    modelStepGradeBody: "Your answer mix is read through the Gyeoltare model and placed from Grade 1 to Grade 7.",
    ...
    modelNotice: "This is not a test with correct answers. It reads your answer mix through the Gyeoltare model.",
    ...
    shareLead: "Based on the Gyeoltare model",
